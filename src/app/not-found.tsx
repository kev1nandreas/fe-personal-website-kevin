...
export default function NotFound() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen text-3xl md:text-5xl font-semibold gap-4">
      ...
      <button
        className="text-sm font-bold text-blue-500 cursor-pointer border-2 p-2 px-4 rounded-lg hover:bg-blue-500 hover:text-white hover:border-transparent mt-2 transition-all duration-200"
        onClick={() => router.back()}
      >
