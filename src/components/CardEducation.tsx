...
export const CardEducation = ({
  ...
  return (
    <div
      className="flex flex-col max-w-[37rem] border-2 rounded-2xl p-5 hover:-translate-y-2 hover:shadow-lg hover:shadow-yellow-500 transition-all duration-300 ease-in-out"
    ...
    >
      ...
      <Typography text={"body"} className="text-justify">
        {description}
      </Typography>
    </div>
  );
